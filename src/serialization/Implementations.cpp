...
DEFINE_TRIVIAL_IMPLEMENTATIONS(BackupStream)
DEFINE_TRIVIAL_IMPLEMENTATIONS(UnmodifiedStream)
DEFINE_TRIVIAL_IMPLEMENTATIONS(FullStream)
DEFINE_TRIVIAL_IMPLEMENTATIONS(RsyncCommand)
DEFINE_TRIVIAL_IMPLEMENTATIONS(RsyncedFile)
DEFINE_TRIVIAL_IMPLEMENTATIONS(RsyncTableItem)
DEFINE_TRIVIAL_IMPLEMENTATIONS(RsyncTable)
